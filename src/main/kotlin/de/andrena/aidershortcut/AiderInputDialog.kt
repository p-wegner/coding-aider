...
class AiderInputDialog(project: Project, files: List<String>) : DialogWrapper(project) {
    private val inputTextArea = JTextArea(5, 30) // Changed to JTextArea for multiline input
    ...
    override fun createCenterPanel(): JComponent {
        ...
        panel.add(JScrollPane(inputTextArea)) // Added JScrollPane for the JTextArea
