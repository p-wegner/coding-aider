...
data class CustomActionConfiguration(
    var name: String = "",
     ...
     */
    fun withRelativePaths(projectRoot: String): CustomActionConfiguration {
     ...
     */
    fun withAbsolutePaths(projectRoot: String): CustomActionConfiguration {
        val root = File(projectRoot)
